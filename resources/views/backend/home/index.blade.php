                        ...
                        <div class="state_w1 mb-1 mt-1">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="sparkline" data-type="bar" data-width="97%"
                                    ...
                                    data-bar-Color="#868e96">5,2,3,7,6,4,8,1</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-6">
            ...
            <div class="body">
                <div class="chat-widget">
                    <ul class="list-unstyled">
                        <li class="left">
                            <img src="{{ asset('adminAssets') }}/images/xs/avatar3.jpg"
                        ...
                        <li class="left">
                            <img src="{{ asset('adminAssets') }}/images/xs/avatar2.jpg"
                                class="rounded-circle" alt="">
                            <ul class="list-unstyled chat_info">
                        ...
                        <li class="left">
                            <img src="{{ asset('adminAssets') }}/images/xs/avatar5.jpg"
                                class="rounded-circle" alt="">
                            <ul class="list-unstyled chat_info">
