                ...
                <div class="single_user_pil d-flex align-items-center justify-content-between">
                    <div class="user_pils_thumb d-flex align-items-center">
                        <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50"
                                src="{{ asset('backendAsset') }}/img/customers/1.png" alt="">
                        </div>
                ...
                <div class="monthly_plan_wraper">
                    <div class="single_plan d-flex align-items-center justify-content-between">
                        <div class="plan_left d-flex align-items-center">
                            <div class="thumb">
                                <img src="{{ asset('backendAsset') }}/img/icon2/7.svg"
                                    alt="">
                            </div>
                            <div>
                                <h5>Most Sales</h5>
                    ...
                    <div class="single_plan d-flex align-items-center justify-content-between">
                        <div class="plan_left d-flex align-items-center">
                            <div class="thumb">
                                <img src="{{ asset('backendAsset') }}/img/icon2/6.svg"
                                    alt="">
                            </div>
                            <div>
                    ...
                    <div class="single_plan d-flex align-items-center justify-content-between">
                        <div class="plan_left d-flex align-items-center">
                            <div class="thumb">
                                <img src="{{ asset('backendAsset') }}/img/icon2/5.svg"
                                    alt="">
                            </div>
                            <div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="single_plan d-flex align-items-center justify-content-between">
                                <div class="plan_left d-flex align-items-center">
                                    <div class="thumb">
                                        <img src="{{ asset('backendAsset') }}/img/icon2/3.svg"
                                            alt="">
                                    </div>
                                    <div>
                                        <h5>$2,034</h5>
                        ...
                        <div class="col-lg-6">
                            <div class="single_plan d-flex align-items-center justify-content-between">
                                <div class="plan_left d-flex align-items-center">
                                    <div class="thumb">
                                        <img src="{{ asset('backendAsset') }}/img/icon2/1.svg"
                                            alt="">
                                    </div>
                                    <div>
                                        <h5>$706</h5>
                        ...
                        <div class="col-lg-6">
                            <div class="single_plan d-flex align-items-center justify-content-between">
                                <div class="plan_left d-flex align-items-center">
                                    <div class="thumb">
                                        <img src="{{ asset('backendAsset') }}/img/icon2/4.svg"
                                            alt="">
                                    </div>
                                    <div>
                                        <h5>$49</h5>
                        ...
                        <div class="col-lg-6">
                            <div class="single_plan d-flex align-items-center justify-content-between">
                                <div class="plan_left d-flex align-items-center">
                                    <div class="thumb">
                                        <img src="{{ asset('backendAsset') }}/img/icon2/2.svg"
                                            alt="">
                                    </div>
                                    <div>
                                        <h5>$5.8M</h5>
                                ...
                                <td>
                                    <div class="customer d-flex align-items-center">
                                        <div class="thumb_34 mr_15 mt-0"><img
                                                ...
                                                src="{{ asset('backendAsset') }}/img/customers/pro_1.png"
                                                alt=""></div>
                            ...
                            <tr>
                                <td>
                                    <div class="customer d-flex align-items-center">
                                        <div class="thumb_34 mr_15 mt-0"><img
                                                class="img-fluid radius_50"
                                                src="{{ asset('backendAsset') }}/img/customers/pro_2.png"
                                                alt=""></div>
                            ...
                            <tr>
                                <td>
                                    <div class="customer d-flex align-items-center">
                                        <div class="thumb_34 mr_15 mt-0"><img
                                                class="img-fluid radius_50"
                                                src="{{ asset('backendAsset') }}/img/customers/pro_3.png"
                                                alt=""></div>
                            ...
                            <tr>
                                <td>
                                    <div class="customer d-flex align-items-center">
                                        <div class="thumb_34 mr_15 mt-0"><img
                                                class="img-fluid radius_50"
                                                src="{{ asset('backendAsset') }}/img/customers/pro_4.png"
                                                alt=""></div>
                            ...
                            <tr>
                                <td>
                                    <div class="customer d-flex align-items-center">
                                        <div class="thumb_34 mr_15 mt-0"><img
                                                class="img-fluid radius_50"
                                                src="{{ asset('backendAsset') }}/img/customers/pro_5.png"
                                                alt=""></div>
                            ...
                            <tr>
                                <td>
                                    <div class="customer d-flex align-items-center">
                                        <div class="thumb_34 mr_15 mt-0"><img
                                                class="img-fluid radius_50"
                                                src="{{ asset('backendAsset') }}/img/customers/pro_6.png"
                                                alt=""></div>
        ...
        <div class="white_card card_height_100 mb_30">
            ...
            <div class="white_card_body">
                <div class="thumb mb_30">
                    <img src="{{ asset('backendAsset') }}/img/table.svg" alt=""
                        class="img-fluid">
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="create_report_btn mt_30">
                                    <a href="#"
                                        class="btn_1 radius_btn d-block text-center">Send the
                                        invitation link</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row min_height_oveflow">
                    <div class="col-lg-4 mb_30">
                        <div
                            ...
                            <div class="user_pils_thumb d-flex align-items-center">
                                <div class="thumb_34 mr_15 mt-0"><img class="img-fluid radius_50"
                                        src="{{ asset('backendAsset') }}/img/customers/1.png"
                                        alt=""></div>
                                <span class="f_s_14 f_w_400 text_color_11">Jhon Smith</span>
                            </div>
                            <div class="user_info">
