...
<body class="theme-blush">
    ...
    <div class="page-loader-wrapper">
        <div class="loader">
            <div class="m-t-30"><img class="zmdi-hc-spin" src="{{asset('adminAssets')}}/images/loader.svg" width="48" height="48"
                    alt="Aero"></div>
            <p>Please wait...</p>
        </div>
    </div>
                            ...
                            <li>
                                <div class="progress-container progress-primary">
                                    ...
                                    <ul class="list-unstyled team-info">
                                        ...
                                        <li>
                                            <img src="{{asset('adminAssets')}}/images/xs/avatar2.jpg" alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="{{asset('adminAssets')}}/images/xs/avatar3.jpg" alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="{{asset('adminAssets')}}/images/xs/avatar4.jpg" alt="Avatar">
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li>
                                <div class="progress-container">
                                    ...
                                    <ul class="list-unstyled team-info">
                                        <li class="m-r-15"><small>Team</small></li>
                                        <li>
                                            <img src="{{asset('adminAssets')}}/images/xs/avatar10.jpg" alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="{{asset('adminAssets')}}/images/xs/avatar9.jpg" alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="{{asset('adminAssets')}}/images/xs/avatar8.jpg" alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="{{asset('adminAssets')}}/images/xs/avatar7.jpg" alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="{{asset('adminAssets')}}/images/xs/avatar6.jpg" alt="Avatar">
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li>
                                <div class="progress-container progress-warning">
                                    ...
                                    <ul class="list-unstyled team-info">
                                        <li class="m-r-15"><small>Team</small></li>
                                        <li>
                                            <img src="{{asset('adminAssets')}}/images/xs/avatar5.jpg" alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="{{asset('adminAssets')}}/images/xs/avatar2.jpg" alt="Avatar">
                                        </li>
    ...
    <aside id="leftsidebar" class="sidebar">
        <div class="navbar-brand">
            ...
            <a href="index.html"><img src="{{asset('adminAssets')}}/images/logo.svg" width="25" alt="Aero"><span
            ...
            <ul class="list">
                ...
                <li class="active open"><a href="javascript:void(0);" class="menu-toggle"><i
                    ...
                    <ul class="ml-menu">
                        ...
                        <li class="active"><a href="form-upload.html">File Upload</a></li>
                    ...
                    <div class="card">
                        <ul class="list-unstyled">
                            <li class="online">
                                <a href="javascript:void(0);">
                                    <div class="media">
                                        <img class="media-object " src="{{asset('adminAssets')}}/images/xs/avatar4.jpg" alt="">
                            ...
                            <li class="online">
                                <a href="javascript:void(0);">
                                    <div class="media">
                                        <img class="media-object " src="{{asset('adminAssets')}}/images/xs/avatar5.jpg" alt="">
                                        <div class="media-body">
                            ...
                            <li class="offline">
                                <a href="javascript:void(0);">
                                    <div class="media">
                                        <img class="media-object " src="{{asset('adminAssets')}}/images/xs/avatar2.jpg" alt="">
                                        <div class="media-body">
                            ...
                            <li class="me">
                                <a href="javascript:void(0);">
                                    <div class="media">
                                        <img class="media-object " src="{{asset('adminAssets')}}/images/xs/avatar1.jpg" alt="">
                                        <div class="media-body">
                            ...
                            <li class="online">
                                <a href="javascript:void(0);">
                                    <div class="media">
                                        <img class="media-object " src="{{asset('adminAssets')}}/images/xs/avatar3.jpg" alt="">
                                        <div class="media-body">
                ...
                <div class="row clearfix">
                    <div class="col-12">
                        <div class="alert alert-warning" role="alert">
                            <strong>dropify</strong> Taken from: <a target="_blank"
                                href="https://github.com/JeremyFagis/dropify">View More</a>
    ...
    <!-- Jquery Core Js -->
    <script src="{{asset('adminAssets')}}/bundles/libscripts.bundle.js"></script> <!-- Lib Scripts Plugin Js -->
    <script src="{{asset('adminAssets')}}/bundles/vendorscripts.bundle.js"></script> <!-- Lib Scripts Plugin Js -->
