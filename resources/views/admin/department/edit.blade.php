                        ...
                        <div class="col-md-9 mt-3">
                            <div class="form-group">
                                <div class="radio inlineblock m-r-20">
                                    <input type="radio" name="status" id="male" class="with-gap" {{ ( isset($department->status) && $department->status == 1) ? 'checked': ''}} checked value="1">
                                    <label for="male">Publish</label>
                                </div>
                                <div class="radio inlineblock">
                                    <input type="radio" name="status" {{ ( isset($department->status) && $department->status == 0) ? 'checked': ''}} id="Female" class="with-gap" value="0">
