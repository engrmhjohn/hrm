                            ...
                            <table class="table">
                                ...
                                @foreach($departments as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.edit.department', $item->id) }}" title="Edit Department"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>

                                            <form action="{{ route('admin.delete.department') }}" method="post" id="delete" style="display:inline">
                                                @csrf
