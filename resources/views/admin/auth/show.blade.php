        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="text-center text-capitalize">Employee Registration</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.auth.storeWorker') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <select name="department_id" id="" class="form-control show-tick ms search-select"
                                    data-placeholder="Select a Department" required>
                                    <option value="" disabled selected></option>
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <select name="designation_id" id="" class="form-control show-tick ms search-select"
                                    data-placeholder="Select a Designation" required>
                                    <option value="" disabled selected></option>
                            ...
                            <div class="col-lg-6 mb-3">
                                ...
                                <select name="pay_slip_id" id="" class="form-control show-tick ms search-select"
                                    data-placeholder="Select a Slip" required>
                                    <option value="" disabled selected></option>
                            ...
                            <div class="col-lg-6 mb-3">
                                <div class="form-group {{ $errors->has('salary') ? 'has-error' : '' }}">
                                    ...
                                    <input class="form-control" name="salary" type="text" id="salary" required>
                            ...
                            <div class="col-lg-6 mb-3">
                                <div class="form-group {{ $errors->has('food_allowance') ? 'has-error' : '' }}">
                                    ...
                                    <input class="form-control" name="food_allowance" type="text"
                                        id="food_allowance" required>
                            ...
                            <div class="col-lg-6 mb-3">
                                <div class="form-group {{ $errors->has('other') ? 'has-error' : '' }}">
                                    ...
                                    <input class="form-control" name="other" type="text" id="other" required>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mt-3">
                                <div class="form-group">
                                    ...
                                    <div class="radio inlineblock">
                                        <input type="radio" name="status" id="unublish" class="with-gap"
                                            value="0">
